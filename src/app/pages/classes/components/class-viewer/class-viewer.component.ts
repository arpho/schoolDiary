import { Component, EventEmitter, inject, Input, OnInit, Output, signal, effect } from '@angular/core';
...
export class ClassViewerComponent implements OnInit {
  ...
  private resolveSubjects() {
    ...
    } else if ('subjectsKey' in this.classe && Array.isArray((this.classe as any).subjectsKey)) {
      // Fallback for cases where it's not a formal AssignedClass instance but has the property
