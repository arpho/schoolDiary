...
import { IonCard, IonCardHeader, IonCardTitle, IonLabel, IonCardContent } from "@ionic/angular/standalone";
...
@Component({
  ...
  standalone: true,
  imports: [IonCard, IonCardHeader, IonCardTitle, IonLabel, IonCardContent],
})
